...
export default async function AllContainersPage(){
    ...
    return (
        <div style={{
            ...
            <TableContainer containerTitle={"Painel de Tabela"} columns={[{columnName: "Coluna 1", items: ["Item 1", "Item 2", "Item 3"]}, {columnName: "Coluna 2", items: ["Item 1", "Item 2", "Item 3"]}, {columnName: "Coluna 3", items: ["Item 1", "Item 2", "Item 3"]}, ]} backgroundColor={cityColor}/>
